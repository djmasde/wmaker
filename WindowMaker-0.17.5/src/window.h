...
typedef struct {
    ...
    unsigned int miniaturizable:1;

    /* decorations */
    unsigned int resizebar:1;	       /* draw the bottom handle? */
    unsigned int close_button:1;       /* draw a close button? */
    unsigned int miniaturize_button:1; /* draw an iconify button? */
